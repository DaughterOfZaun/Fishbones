...
- Download [Godot_v4.7.1-stable_win64.exe.zip](https://github.com/godotengine/godot-builds/releases/download/4.7.1-stable/Godot_v4.7.1-stable_win64.exe.zip) and extract `Godot_v4.7.1-stable_win64.exe` to `./dist` as `Godot_v4.7.1-stable_win64.exe`
- Download [Godot_v4.7.1-stable_export_templates.tpz](https://github.com/godotengine/godot-builds/releases/download/4.7.1-stable/Godot_v4.7.1-stable_export_templates.tpz) (1.26 GB)
...
- Run `./dist/Godot_v4.6-stable_win64.exe`
  ...
  - Navigate `Editor` -> `Manage Export Templates` -> `Install from File` -> select `Godot_v4.7.1-stable_export_templates.tpz` -> Open
- Run the following command

```bash
bun run ./build.ts install patch-modules embeds protons bun godot release windows 0.0.3.53
```
