...
export const godotExeEmbedded = 'res://embedded/Godot_v4.5-stable_win64.exe'
export const godotPckEmbedded = 'res://embedded/Godot_v4.5-stable_win64.pck'
...
export const s7zExeEmbedded = 'res://embedded/7z.exe'
export const s7zDllEmbedded = 'res://embedded/7z.dll'
