...
export const champions: [string, string, 'Working' | 'Playable' | 'Buggy' | 'Unimplemented' | false ][] = [
    ...
    ["Annie", "Annie", "Working"],
    ["Ashe", "Ashe", "Playable"],
    ["FiddleSticks", "Fiddlesticks", "Working"],
    ["Jax", "Jax", "Working"],
    ["Kayle", "Kayle", "Working"],
    ["MasterYi", "Master Yi", "Playable"],
    ["Morgana", "Morgana", "Working"],
    ["Nunu", "Nunu & Willump", "Working"],
    ["Ryze", "Ryze", "Working"],
    ["Sion", "Sion", "Working"],
    ["Sivir", "Sivir", "Working"],
    ["Soraka", "Soraka", "Working"],
    ["Teemo", "Teemo", "Playable"],
    ["Tristana", "Tristana", "Working"],
    ["TwistedFate", "Twisted Fate", "Playable"],
    ["Warwick", "Warwick", "Working"],
    ["Singed", "Singed", "Working"],
    ["Zilean", "Zilean", "Working"],
    ["Evelynn", "Evelynn", "Playable"],
    ["Tryndamere", "Tryndamere", "Working"],
    ["Twitch", "Twitch", "Playable"],
    ["Karthus", "Karthus", "Playable"],
    ["Amumu", "Amumu", "Working"],
    ["Chogath", "Cho'Gath", "Buggy"],
    ["Anivia", "Anivia", "Playable"],
    ["Rammus", "Rammus", "Playable"],
    ["Veigar", "Veigar", "Playable"],
    ["Kassadin", "Kassadin", "Working"],
    ["Gangplank", "Gangplank", "Working"],
    ["Taric", "Taric", "Working"],
    ["Blitzcrank", "Blitzcrank", "Working"],
    ["DrMundo", "Dr. Mundo", "Playable"],
    ["Janna", "Janna", "Working"],
    ["Malphite", "Malphite", "Playable"],
    ["Corki", "Corki", "Working"],
    ["Katarina", "Katarina", "Buggy"],
    ["Nasus", "Nasus", "Playable"],
    ["Heimerdinger", "Heimerdinger", "Playable"],
    ["Shaco", "Shaco", "Buggy"],
    ["Udyr", "Udyr", "Working"],
    ["Nidalee", "Nidalee", "Playable"],
    ["Poppy", "Poppy", "Buggy"],
    ["Gragas", "Gragas", "Playable"],
    ["Pantheon", "Pantheon", "Playable"],
    ["Mordekaiser", "Mordekaiser", "Working"],
    ["Ezreal", "Ezreal", "Working"],
    ["Shen", "Shen", "Working"],
    ["Kennen", "Kennen", "Working"],
    ["Garen", "Garen", "Working"],
    ["Akali", "Akali", "Working"],
    ["Malzahar", "Malzahar", "Working"],
    ["Olaf", "Olaf", "Playable"],
    ["KogMaw", "Kog'Maw", "Working"],
    ["XinZhao", "Xin Zhao", "Working"],
    ["Vladimir", "Vladimir", "Working"],
    ["Galio", "Galio", "Working"],
    ["Urgot", "Urgot", "Playable"],
    ["MissFortune", "Miss Fortune", "Working"],
    ["Sona", "Sona", "Working"],
    ["Swain", "Swain", "Working"],
    ["Lux", "Lux", "Working"],
    ["Leblanc", "LeBlanc", "Buggy"],
    ["Irelia", "Irelia", "Working"],
    ["Trundle", "Trundle", "Working"],
    ["Cassiopeia", "Cassiopeia", "Working"],
    ["Caitlyn", "Caitlyn", "Working"],
    ["Renekton", "Renekton", "Working"],
    ["Karma", "Karma", "Working"],
    ["Maokai", "Maokai", "Working"],
    ["JarvanIV", "Jarvan IV", "Playable"],
    ["Nocturne", "Nocturne", "Playable"],
    ["LeeSin", "Lee Sin", "Playable"],
    ["Brand", "Brand", "Working"],
    ["Rumble", "Rumble", "Playable"],
    ["Vayne", "Vayne", "Playable"],
    ["Orianna", "Orianna", "Buggy"],
    ["Yorick", "Yorick", "Working"],
    ["Leona", "Leona", "Working"],
    ["MonkeyKing", "Wukong", "Buggy"],
    ["Skarner", "Skarner", "Playable"],
    ["Talon", "Talon", "Working"],
    ["Riven", "Riven", "Buggy"],
    ["Xerath", "Xerath", "Playable"],
    ["Graves", "Graves", "Unimplemented"],
    ["Shyvana", "Shyvana", "Unimplemented"],
    ["Fizz", "Fizz", "Unimplemented"],
    ["Volibear", "Volibear", "Unimplemented"],
